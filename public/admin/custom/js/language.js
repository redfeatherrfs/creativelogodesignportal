(function ($) {
    ...
    var adminLanguageSearchTable;
    $(document).on("input", "#adminMultiLanguageSearch", function () {
        adminLanguageSearchTable.search($(this).val()).draw();
    });


    adminLanguageSearchTable = $('#languageDataTable').DataTable({
        pageLength: 10,
        ordering: false,
        serverSide: true,
        processing: true,
