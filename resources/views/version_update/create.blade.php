    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
        <div class="customers__area">
            <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15">
                ...
                @if (getCustomerCurrentBuildVersion() < $latestBuildVersion)
                    <div class="col-lg-12">
                        <div class="m-auto max-w-892 customers__area bg-style">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="d-flex justify-content-center align-items-center cg-10">
                                                <div
                                                    class="btn btn-success mb-4 p-2 dz-clickable"
                                                    id="dz-clickable">
            ...
            <div class="bg-white bd-one bd-c-stroke bd-ra-10 p-sm-30 p-15 mt-20">
                <h4 class="fs-18 fw-600 lh-20 text-title-text pb-20">{{ __('Addons') }}</h4>

                @forelse($addons as $addon)

                    <div class="bd-one bd-c-black-stroke bd-ra-8 p-sm-25 p-15">
                        <div class="row align-items-center row-gap-2">
                            ...
                            <div class="col-sm-6 col-md-8 col-lg-5">
                                <div class="pb-10 d-flex align-items-center cg-10 flex-wrap">
                                    <a href="{{ $addon->details->codecanyon_url }}" target="_blank"
                                       class="fs-16 fw-500 lh-20 text-title-text">
                                        {{ $addon->title }}
                                    </a>
                            ...
                            <div class="col-md-2 col-lg-6 text-end rtl-versionUpdate-link">
                                <a href="{{ route('admin.addon.details', $addon->code) }}"
                                   class="sf-cursor-pointer d-inline-flex align-items-center cg-10 bd-ra-8 bg-button py-5 px-15 fs-15 fw-600 lh-25 text-white">
                ...
                @empty
                    <p class="alert alert-warning">{{__('No addon found!')}}</p>
                @endforelse
