...
@endpush
@section('content')
    <div class="m-auto max-w-894 p-30">
        <h4 class="fs-24 fw-500 lh-34 pb-10 text-black">{{ __($pageTitle) }}</h4>
                ...
                <div class="customers__area bg-style">
                    <div class="table-responsive">
                        <table class="table zTable zTable-last-item-right">
                            ...
                            <tbody>
                                <tr>
                                    <th class="fw-400">{{ __('Addon Current Version') }}</th>
                                    <td>
                                ...
                                <tr class="d-none">
                                    <th class="fw-400">{{ __('Addon Current  Code Version') }}</th>
                                    <td>
                                        {{ getAddonCodeCurrentVersion($code) }}
                                    </td>
                                </tr>
                                <tr class="d-none">
                                    <th class="fw-400">{{ __('Addon Current DB Version') }}</th>
                                    <td>
                                        {{ getAddonCodeBuildVersion($code) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="fw-400">{{ __('Application Required Version') }}</th>
                                    <td>
                                        {{ $appLatestVersion }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="fw-400">{{ __('Application Current Version') }}</th>
                                    <td>
