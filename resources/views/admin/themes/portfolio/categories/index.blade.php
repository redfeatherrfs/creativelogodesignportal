...
@section('content')
        ...
        <div class="row rg-20">
            <div class="col-xl-12">
                ...
                <div class="p-sm-25 p-15 bd-one bd-c-black-stroke bd-ra-10 bg-white">
                    <table class="table zTable zTable-last-item-right" id="portfolioCategoryDatatable">
                        <thead>
                        <tr>
                            <th scope="col">
                                <div>{{ __('#Sl') }}</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div class="bd-b-one bd-c-black-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
                    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Add Portfolio Category') }}</h2>
                    <div class="mClose">
                        <button type="button"
    ...
    <input type="hidden" id="theme-portfolio-category-route" value="{{ route('admin.theme-settings.portfolios.categories.index') }}">
@endsection

@push('script')
    <script src="{{ asset('admin/theme/js/portfolio-category.js') }}"></script>
@endpush
