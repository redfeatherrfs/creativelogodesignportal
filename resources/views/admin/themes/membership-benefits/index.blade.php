...
@section('content')
            ...
            <div class="col-xl-9">
                <div
                    ...
                    <button class="border-0 bg-button py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white" type="button"
                        ...
                        {{ __('Add Membership Benefits') }}
                    </button>
                </div>
                <div class="p-sm-25 p-15 bd-one bd-c-black-stroke bd-ra-10 bg-white">
                    <table class="table zTable zTable-last-item-right" id="membershipBenefitsDataTable">
                        <thead>
                        <tr>
                            <th scope="col">
                                <div>{{ __('Icon') }}</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div class="bd-b-one bd-c-black-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
                    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Add Membership Benefits') }}</h2>
                    <div class="mClose">
                        <button type="button"
    ...
    <input type="hidden" id="theme-membership-benefits-route" value="{{ route('admin.theme-settings.membership-benefits.index') }}">
@endsection

@push('script')
    <script src="{{ asset('admin/theme/js/membership-benefits.js') }}"></script>
@endpush
