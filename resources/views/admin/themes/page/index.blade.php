...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0 bd-ra-4 p-sm-25 p-15">
                <div class="bd-b-one bd-c-black-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
                    <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Add Page') }}</h2>
                    <div class="mClose">
                        <button type="button"
                    ...
                    <div class="row rg-20">
                        ...
                        <div class="pt-15">
                            <label class="zForm-label-alt">{{ __('Description') }} <span
                                    class="text-danger">*</span></label>
                            <textarea class="summernoteOne" name="description" placeholder="{{__('Type description')}}"></textarea>
                        </div>
                    </div>
    ...
    <input type="hidden" id="theme-choose-us-route" value="{{ route('admin.theme-settings.pages.index') }}">
@endsection

@push('script')
    <script src="{{ asset('admin/theme/js/page.js') }}"></script>
@endpush
