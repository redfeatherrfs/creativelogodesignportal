<div class="email-inbox__area">
    <div class="bd-b-one bd-c-black-stroke pb-20 mb-20 d-flex align-items-center flex-wrap justify-content-between g-10">
        <h2 class="fs-18 fw-600 lh-22 text-title-text">{{ __('Faq Area') }}</h2>
    ...
    <form class="ajax" action="{{ route('admin.setting.configuration-landing-page-settings.update') }}" method="POST"
        ...
        <div class="row rg-20">
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                ...
                <input type="hidden" name="faq_sub_title" value="">
                <select class="primary-form-control sf-select-edit-modal" multiple name="faq_sub_title[]">
                    @php
                        $subTitles = json_decode(landingPageSetting($collection, 'faq_sub_title') ?? '');
                    @endphp
            ...
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-3">
                ...
                <input type="text" name="faq_title"
                       value="{{ landingPageSetting($collection, 'faq_title') }}"
