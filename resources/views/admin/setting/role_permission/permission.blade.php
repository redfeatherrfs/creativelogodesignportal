        ...
        <div class="row rg-20">
            ...
            <div class="col-xl-9">
                <form class="ajax " action="{{route('admin.setting.role-permission.permission-update')}}" method="POST"
                      ...
                      data-redirect-url="{{ route('admin.setting.role-permission.list') }}">
                    @csrf
                    <div class="p-sm-25 p-15 bd-one bd-c-black-stroke bd-ra-10 bg-white mb-25">
                        <!--  -->
                        <input type="hidden" name="role" value="{{encodeId($roleData->id)}}">
                        <div class="d-flex cg-5">
                            <h4 class="fs-14 fw-600 lh-20 text-title-text pb-25"> {{__("Role Name: ")}}</h4>
                            <h4 class="fs-14 fw-500 lh-20 text-title-text pb-25 al"> {{$roleData->name}}</h4>
                        </div>
                    ...
                    <div class="d-flex g-12 flex-wrap">
                        <button type="submit" class="py-10 px-26 bg-button bd-one bd-c-button bd-ra-8 fs-15 fw-600 lh-25 text-white">{{__("Save Changes")}}</button>
