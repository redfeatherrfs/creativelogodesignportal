...
@section('content')
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15 overflow-x-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap g-10 pb-20">
            <!--  -->
            <h4 class="fs-18 fw-600 lh-22 text-title-text"></h4>
            <!--  -->
            <div class="d-flex flex-wrap g-10">
                <a href="{{route('admin.ticket.edit', encrypt($ticketDetails->id))}}" class="py-10 px-26 d-flex align-items-center g-12 fs-15 fw-600 lh-25 text-white bg-button bd-one bd-c-button bd-ra-8">
                    <div class="d-flex">
                ...
                <button onclick="deleteItem('{{route('admin.ticket.delete', encrypt($ticketDetails->id))}}' , 'no','{{route('admin.ticket.list')}}')" class="py-10 px-26 d-flex align-items-center g-12 fs-15 fw-600 lh-25 text-para-text bg-transparent bd-one bd-c-black-stroke bd-ra-8">
                    <div class="d-flex">
        ...
        <div class="row justify-content-center rg-20">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="bd-one bd-c-black-stroke bd-ra-10 p-sm-25 p-15 bg-white">
                    <!--  -->
                    <h4 class="fs-18 fw-600 lh-22 text-title-text bd-b-one bd-c-black-stroke pb-17 mb-17">{{__("Ticket Info")}}</h4>
                    <!--  -->
                    <ul class="zList-pb-18 bd-b-one bd-c-black-stroke pb-18 mb-18">
                        <li>
                            <h5 class="fs-14 fw-500 lh-17 text-title-text pb-8">{{__("Ticket ID")}}</h5>
                            <p class="fs-12 fw-500 lh-15 text-para-text">{{$ticketDetails->ticket_id}}</p>
                        </li>
                        <li>
                            <h5 class="fs-14 fw-500 lh-17 text-title-text pb-8">{{__("Order ID")}}</h5>
                            <p class="fs-12 fw-500 lh-15 text-para-text">{{$ticketDetails->order_id}}</p>
                        </li>
                        <li>
                            <h5 class="fs-14 fw-500 lh-17 text-title-text pb-8">{{__("Client Email")}}</h5>
                        ...
                        <li>
                            <div class="d-flex align-items-center justify-content-between g-10">
                                <!--  -->
                                <div>
                                    <h5 class="fs-14 fw-500 lh-17 text-title-text pb-8">{{__("Priority")}}</h5>
                                ...
                                <div class="dropdown dropdown-one">
                                    <button class="dropdown-toggle p-0 bg-transparent w-30 h-30 bd-one bd-c-black-stroke rounded-circle d-flex justify-content-center align-items-center text-para-text fs-10" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-angle-down"></i></button>
                    ...
                    <!--  -->
                    <div class="">
                        <h5 class="fs-14 fw-500 lh-17 text-title-text pb-8">{{__("Assign More")}}</h5>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="d-flex flex-column rg-15">
                    ...
                    <div class="bd-one bd-c-black-stroke bd-ra-10 p-sm-25 p-15 bg-white">
                        <!--  -->
                        <div class="bd-b-one bd-c-black-stroke pb-14 mb-20">
                            <div class="d-flex align-items-center g-8">
                                <div class="flex-shrink-0 w-30 h-30 rounded-circle overflow-hidden"><img src="{{getFileUrl($ticketDetails->client_image)}}" alt="" /></div>
                                <h4 class="fs-15 fw-500 lh-20 text-title-text">{{$ticketDetails->client_name}} <span class="text-para-text">({{__("Client")}})</span></h4>
                            </div>
                        </div>
                        <!--  -->
                        <div>
                            <h4 class="fs-14 fw-500 lh-20 text-title-text pb-8">{{__("Details")}}</h4>
                                        ...
                                        @else
                                            <li>
                                                <a href="{{ getFileUrl($file)  }}" target="_blank"
                                                   class="p-10 bd-one bd-c-black-stroke bd-ra-10 bg-body-bg d-inline-flex flex-column g-13">
                                                    <div class="d-flex"><img
                                                            src="{{ asset('assets/images/icon/files-1.svg')}}" alt=""/>
                                                    </div>
                                                    <p class="fs-14 fw-400 lh-17 text-title-text">{{getFileData($file, 'file_name')}}</p>
                                                    <div class="d-flex align-items-center">
                                                        <!-- File size -->
                                                        <h4 class="fs-12 fw-400 lh-15 text-para-text pr-8 bd-r-one bd-c-black-stroke">{{getFileData($file, 'size')}}
                                                            B</h4>
