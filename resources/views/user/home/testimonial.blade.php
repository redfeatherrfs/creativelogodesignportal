...
<div class="carousel-item active">
  <div class="cs-slide">
    ...
    <div class="cs-author">
      <div class="cs-role fw-bold">DIRECTOR OF ECOMMERCE</div>
      <div class="text-muted small">The Fragrance Group</div>
    </div>
  </div>
</div>
...
<div class="carousel-item">
  <div class="cs-slide">
    ...
    <div class="cs-stars" data-stars="5"></div>
    <div class="cs-author">
      <div class="cs-role fw-bold">VP MARKETING</div>
      <div class="text-muted small">DTC Apparel Brand</div>
    </div>
  </div>
</div>
...
<div class="carousel-item">
  <div class="cs-slide">
    ...
    <div class="cs-author">
      <div class="cs-role fw-bold">PRODUCT MANAGER</div>
      <div class="text-muted small">Fintech SaaS</div>
    </div>
  </div>
</div>
...
<div class="carousel-item">
  <div class="cs-slide">
    ...
    <div class="cs-stars" data-stars="5"></div>
    <div class="cs-author">
      <div class="cs-role fw-bold">GROWTH LEAD</div>
      <div class="text-muted small">Healthcare Marketplace</div>
    </div>
  </div>
</div>
...
<div class="carousel-item">
  <div class="cs-slide">
    ...
    <div class="cs-stars" data-stars="5"></div>
    <div class="cs-author">
      <div class="cs-role fw-bold">CREATIVE DIRECTOR</div>
      <div class="text-muted small">Hospitality Group</div>
    </div>
  </div>
</div>
  ...
  <div class="cs-slide">
    ...
    <div class="cs-author">
      ...
      <div class="text-muted small">Public Sector</div>
          ...
          <!-- controls -->
          <button class="carousel-control-prev cs-nav" type="button" data-bs-target="#testiCarousel" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
          </button>
          <button class="carousel-control-next cs-nav" type="button" data-bs-target="#testiCarousel" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Next</span>
          </button>

          <!-- dots -->
          <div class="carousel-indicators cs-dots">
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="0" class="active" aria-current="true"></button>
            ...
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="3"></button>
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="4"></button>
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="5"></button>
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="6"></button>
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="7"></button>
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="8"></button>
            <button type="button" data-bs-target="#testiCarousel" data-bs-slide-to="9"></button>
          </div>
        </div>
      </div>
    </div>
