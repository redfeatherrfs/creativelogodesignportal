    ...
    <span id="searchresult">
        @if ($invoiceCount > 0)
            <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
                ...
                <div class="d-flex flex-column-reverse flex-md-row justify-content-center justify-content-md-between align-items-center align-items-md-start flex-wrap g-10 table-pl">
                    <!-- Left -->
                    <ul class="nav nav-tabs zTab-reset zTab-five flex-wrap pl-sm-20" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link bg-transparent invoiceStatusTab" id="completedOrder-tab"
                                    data-bs-toggle="tab" data-bs-target="#completedOrder-tab-pane" type="button"
                                    role="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link bg-transparent invoiceStatusTab" id="pendingOrder-tab"
                                    data-bs-toggle="tab" data-bs-target="#pendingOrder-tab-pane" type="button"
                                    role="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link bg-transparent invoiceStatusTab" id="cancelledOrder-tab"
                                    data-bs-toggle="tab" data-bs-target="#cancelledOrder-tab-pane" type="button"
                                    role="tab"
                ...
                <div class="tab-content" id="myTabContent">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                         ...
                                         <th>
                                            <div class="text-nowrap">{{__('Plan')}}</div>
                                        </th>
                                        <th>
                    ...
                    <!-- Working Order -->
                    <div class="tab-pane fade" id="pendingOrder-tab-pane" role="tabpanel"
                    ...
                    <div class="tab-pane fade" id="completedOrder-tab-pane" role="tabpanel"
                        ...
                        <div class="bg-white bd-one bd-c-black-stroke bd-ra-10 p-sm-30 p-15">
                            <table class="table zTable zTable-last-item-right"
                                   id="invoiceTable-{{ PAYMENT_STATUS_PAID }}">
                                <thead>
                                    <tr>
                                        <th>
                                            <div>{{ __('Sl') }}</div>
            ...
            <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15">
                <div class="p-sm-30 p-15 bg-white bd-one bd-c-black-stroke bd-ra-10">
                    <div class="create-wrap">
                        <div class="mb-22 text-center"><img src="{{ asset('assets/images/create-icon.png') }}" alt=""/>
                        </div>
                        <h4 class="pb-22 fs-24 fw-500 lh-30 text-title-text text-center">
                            {{ __("There is no Invoice available here!") }}
                        </h4>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content border-0 bd-ra-4 p-25">
                <div class="d-flex justify-content-between align-items-center g-10 flex-wrap pb-20">
                    <h4 class="fs-18 fw-500 lh-22 text-title-text">{{ __('Select Payment Method') }}</h4>
                    <button type="button"
                            ...
                            <div class="bd-one bd-c-black-stroke bd-ra-8 p-sm-25 p-15 bg-white">
                                ...
                                <ul class="zList-pb-12">
                                    <li class="d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="fs-14 fw-400 lh-16 text-title-text" id="showInvoiceId"></p>
                                    </li>
                                    <li class="d-flex justify-content-between align-items-center">
                                        <p class="fs-14 fw-400 lh-16 text-para-text">{{ __('Amount') }}</p>
                                        <p class="fs-14 fw-400 lh-16 text-title-text" id="showInvoiceAmount"></p>
                                    </li>
                                </ul>
                                <ul class="zList-pb-12 pt-20 mt-20 bd-t-one bd-c-black-stroke"
                                    id="gatewayCurrencyAppend">
                                </ul>
                            </div>
                            <div class="bg-white bd-one bd-c-black-stroke bd-ra-10 p-sm-20 p-10 mt-20 d-none"
                                 id="bankSection">
                                <h4 class="fs-16 fw-600 lh-19 text-title-text pb-15 mb-18 bd-b-one bd-c-black-stroke">
                                    {{ __('Bank Deposit') }}</h4>
                                ...
                                <p class="fs-14 fw-500 lh-17 text-para-text p-10 mb-20 bd-one bd-c-black-stroke bd-ra-8"
                                   id="bankDetails"></p>
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="bd-one bd-c-black-stroke bd-ra-10 p-sm-20 p-10 payment-item">
                                            ...
                                            <button type="button" data-gateway="{{ $gateway->slug }}"
                                                    data-id="{{ $gateway->id }}"
                                                    class="bd-one bd-c-black-stroke bd-ra-5 py-8 p-sm-20 p-10 w-100 bg-white fs-14 fw-400 lh-16 text-para-text paymentGateway">{{ __('Select') }}</button>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
